...
- Секция "`in`"
  ...
  - `raw_subdir` - подкаталог в папке "\_raw" или архив zip/rar в ней, где содержаться исходные данные. Eсли исходные файлы не в архиве или подпапке от "\_raw", то ничего не указывать или закомментировать в yml.
