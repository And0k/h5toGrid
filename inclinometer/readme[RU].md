...
- Секция "`out`"
  - `db_name` - имя выходного hdf5 файла 1го этапа работы программы (см [ниже](#Программа-работает-в-два-этапа)), к hdf5 файлам следующего этапа добавляются соответствующие суффиксы. По умолчанию "incl.h5" с приставкой из цифр если `path_cruise` с них начинается (у меня названия директорий данных вначале содержат время их начала ггммдд)
