"""
Download data from Copernicus Marine Service for a points array (nearest avail. in grid) with common settings
"""
...
# Array of points to download data for
points = (
    (55.16547, 20.59055),
    # (55.26527, 19.67321),
...
# Common parameters for all points
date_range = (
    ("2025-04-24", "2025-05-31")
...
for i, (dataset, vars) in enumerate(dataset_vars.items(), start=1):
    ...
    if vars == 'deptho':
        ...
        del params['start_datetime']  # depth not depends on time
