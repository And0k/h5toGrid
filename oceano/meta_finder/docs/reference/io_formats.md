...
Text list of paths grouped by cruise. Generated by [`write_files_list()`](../../src/meta_finder/file_writer.py#L14).
...
- Data files for each instrument sorted by priority (as described in [File name parsing](#file-name-parsing)).
