...
from utils.init import ini2dict, dir_walker, readable, bGood_dir, bGood_file
...
try:
    from utils.grid2d_vsz import save_shape, to_polygon
...
def old_repInFile_for_vszs():
    ...
    # loadRDCP_INI = r'\
    # d:\workData\_source\KaraSea\150816_Kartesh-river_Ob\ADVS_RDI#17937 — копия\magn_decl.ini
    # \\\
    # '
