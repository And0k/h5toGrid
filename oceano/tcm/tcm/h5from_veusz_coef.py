...
from utils.init import cfg_from_args, this_prog_basename, init_file_names, init_logging, Ex_nothing_done, dir_from_cfg,\
            ...
            for i, name_out in enumerate(names_get_fits):  # ['fit1', 'fit2']
                ...
                h5copy_coef(
                    ...
                    dict_matrices={
                        ...
                        f"//coef//date": np.float64([np.nan, np.datetime64(datetime.now()).astype(np.int64)]),
                    },
                )
...
if __name__ == '__main__':
    ...
    main([
        str(Path(veuszPropagate.__file__).with_name('veuszPropagate.ini')),
