...
if to_vaex:
    ...
    from hdf5_alt.csv_to_h5vaex import h5pandas_to_vaex, h5pandas_to_vaex_combine  #, h5pandas_to_vaex_file_names
    ...
    import numpy as np
    import pandas as pd
    from hdf5_pandas.h5_dask_pandas import h5_load_range_by_coord, h5.append
