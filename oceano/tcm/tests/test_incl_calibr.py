import pytest
import sys
from tcm.incl_calibr_hy import *
from tcm.incl_calibr_hy import __file__ as path_incl_calibr_hy
...
def test_main(sys_argv_like_no_test):
    ...
    cfg = main_call([
        ...
        r'--config-name=210603incl_load#b-caliblab.yml'
        #'201219incl_load-caliblab.yml'
