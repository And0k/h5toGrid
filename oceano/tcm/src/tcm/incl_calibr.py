...
from tcm.h5inclinometer_coef import h5copy_coef, channel_cols, dict_matrices_for_h5  # , lf
from tcm.incl_h5clc import incl_calc_velocity_nodask
from utils.init import cfg_from_args, this_prog_basename, init_logging, standard_error_info
from hdf5_pandas import h5
from utils.filters import is_works
from utils.filters_scipy import despike
from utils.plot_int import make_figure
...
def my_argparser():
    ...
    """
    from utils.init import my_argparser_common_part

    p = my_argparser_common_part({
        'description': 'Grid data from Pandas HDF5, VSZ files and Pandas HDF5 store*.h5'
    })
...
def calibrate_plot(
        raw3d: np.ndarray, a2d: np.ndarray, b, fig=None, window_title=None, clear=True,
...
if __name__ == '__main__':
    ...
    # cfg = ini2dict(r'D:\Work\_Python3\_projects\PyCharm\h5toGrid\hdf5_pandas\csv_inclin_Baranov.ini')
    # tbl = cfg['out']['table']
    # tblL = tbl + '/log'
