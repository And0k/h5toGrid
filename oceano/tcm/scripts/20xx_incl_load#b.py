from tcm.incl_load import main as incl_load
# incl_load([
...
incl_load([
    'cfg/220906incl_load#b_KaS.yml',  #220910incl_load#b.yml 230109incl_load#b.yml  200907incl_load#b.yml
    #'--raw_subdir', 'Инкл_2022_12_01.rar'  # '{prefix:}{number:0>2}.ZIP',
