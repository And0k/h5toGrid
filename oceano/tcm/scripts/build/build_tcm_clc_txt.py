"""Build tcm_clc_txt distribution via PyInstaller. Updates VERSION (version.py) if env BUILD_MODE==manual """
import os
import subprocess
import sys
...
SPEC = PROJECT_ROOT / "scripts" / "build" / "tcm_clc_txt.spec"
...
if result.returncode == 0:
    print(f"\nBuild complete: {PROJECT_ROOT / 'dist' / 'tcm_clc_txt' / 'tcm_clc_txt.exe'}")
